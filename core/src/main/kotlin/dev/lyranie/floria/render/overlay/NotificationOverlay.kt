...
import dev.lyranie.floria.render.screen.ClientNotificationOverlayScreen
import net.minecraft.client.gui.DrawContext

object NotificationOverlay : ClientOverlay() {
    fun init(drawContext: DrawContext) {
        if (instance != null) return

        instance = ClientNotificationOverlayScreen()
